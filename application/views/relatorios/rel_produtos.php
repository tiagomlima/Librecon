    ...
    <div class="span4">
        <div class="widget-box">
            ...
            <div class="widget-content">
                <ul class="site-stats">
                    <li><a target="_blank" href="<?php echo base_url()?>index.php/relatorios/acervosRapid"><i class="icon-barcode"></i> <small>Todos os Acervos</small></a></li>
                    <li><a target="_blank" href="<?php echo base_url()?>index.php/relatorios/acervosRapidMin"><i class="icon-barcode"></i> <small>Com Estoque Mínimo</small></a></li>
        ...
        <div class="widget-box">
            ...
            <div class="widget-content">
                <div class="span12 well">
                    ...
                    <form target="_blank" action="<?php echo base_url() ?>index.php/relatorios/acervosCustom" method="get">
                        <div class="span12 well">
                            <div class="span6">
