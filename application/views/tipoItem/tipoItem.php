<a href="<?php echo base_url()?>index.php/tipoItem/adicionar" class="btn btn-success"><i class="icon-plus icon-white"></i> Adicionar Usuário</a>
<?php
if(!$results){?>
        ...
        <?php foreach ($results as $r) {
            ...
            echo '<td>';
                      if($this->permission->checkPermission($this->session->userdata('permissao'),'eTipoItem')){
                		echo '<a href="'.base_url().'index.php/tipoItem/editar/'.$r->idCursos.'" style="margin-right: 1%" class="btn btn-info tip-top" title="Editar Curso"><i class="icon-pencil icon-white"></i></a>'; 
           		 	  }
