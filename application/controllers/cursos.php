...
class Cursos extends CI_Controller {
	...
	function gerenciar(){
        ...
        if(!$this->permission->checkPermission($this->session->userdata('permissao'),'cCurso')){
	    ...
	    $this->data['results'] = $this->cursos_model->get('cursos','idCursos,nomeCurso,disciplina','',$config['per_page'],$this->uri->segment(3));
    ...
    public function visualizar(){
        ...
        if(!$this->permission->checkPermission($this->session->userdata('permissao'),'cCursos')){
           $this->session->set_flashdata('error','Você não tem permissão para visualizar cursos.');
           redirect(base_url());
        }
